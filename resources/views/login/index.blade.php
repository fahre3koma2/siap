...
<head>
    ...
    <!-- sweetalert -->
    <script src="{{ asset('public/assets/sweetalert/js/sweetalert.min.js') }}"></script>
    <link rel="stylesheet" type="text/css" href="{{ asset('public/assets/sweetalert/css/sweetalert.css') }}">
        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                    <a href="index.html">
                        <img class="align-content" src="{{ asset('public/images/'.$site->logo) }}" alt="">
                    </a>
                </div>
                     ...
                     {{ csrf_field() }}
                        ...
                        <div class="checkbox">
                            ...
                            <label class="pull-right">
                                <a href="{{ asset('login/lupa') }}">Forgotten Password?</a>
                            </label>
